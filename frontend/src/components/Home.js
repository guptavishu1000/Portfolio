          ...
          {personalInfo && (
            ...
            >
              ...
              {personalInfo?.linkedin && (
                <a
                  ...
                  className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="code-forces" fill="currentColor" className="w-8 h-8">
            ...
            {personalInfo?.linkedin && (
              <a
                ...
                className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="kaggle" fill="currentColor" className="w-8 h-8">
